...
function beforeStringOrStrings(memberOrMembers: string, member2?: string, member3?: string){
    if (member2 && member3) {
...
console.log(beforeStringOrStrings('안유진, 장원영,레이'));
console.log(beforeStringOrStrings('안유진', '장원영', '레이'));
console.log(beforeStringOrStrings ('안유진', '장원영')); // error
...
console.log(stringOrStrings('안유진', '장원영', '레이'));
// console.log(stringOrStrings ('안유진', '장원영')); // error